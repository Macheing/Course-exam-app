...
def extract_answers(request):
    '''
    A example method to collect the selected choices from the exam form from 
    the request object
    '''
    submitted_anwsers = []
...
def show_exam_result(request, course_id, submission_id):
    ...
    and result for each question based on the following logic:
    ...
    context = {"course":course, "choices":choices,"mark":mark, 
                "total_mark": total_mark, "submission": submission,
